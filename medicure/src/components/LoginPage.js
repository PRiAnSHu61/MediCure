    ...
    <div className='Login_Modal'>
       ...
       <div className='Login_Left_Section'>
        ...
        <div className='Login_Right_Section'>
            ...
            <div className='SubHeading'>New to Medicure? <span onClick={()=>setSignup(true)}>Sign-Up</span></div>
            ...
            <div className='LastLine'>By joining you agree to the MediCure Terms of Services and to occasionally receive emails from us. Please read our Privacy Policy to learn how we use your personal data.</div>
        </div>
        </>
        :
        <>
        ...
        <div className='Login_Right_Section'>
            <div className='Heading'> Welcome Back!</div>
            <div className='SubHeading'>New to Medicure? <span onClick={()=>setSignup(false)}>Login</span></div>
            <div className='LoginUsing'>
                <div className='Phone'>
                    <img src={Phone} alt='Phone'/>
